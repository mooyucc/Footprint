...
class LanguageManager: ObservableObject {
    ...
    private func loadLocalizedStrings() {
        ...
        localizedStrings["zh-Hans"] = [
            ...
            "import_result": "导入结果",
            "ok": "确定",
            "import_success": "成功导入游记",
            "trip_exists": "游记已存在",
            "import_failed": "导入失败",
            "days": "天",
            "locations": "个地点",
            "trip_statistics": "游记统计",
            "no_trip_records": "还没有记录游记",
            "create_first_trip": "记录第一篇游记",
            "start": "开始",
            "end": "结束",
            "duration": "时长",
            "trip_route": "足迹路线",
            ...
            "edit_trip": "编辑游记",
            "delete_trip": "删除游记",
            "confirm_delete_trip": "确定要删除这篇游记吗？点亮的地方不会被删除。",
            "trip_info": "游记信息",
            "trip_name": "游记名称",
            ...
            "belongs_to_trip_optional": "所属游记（可选）",
            "select_trip": "选择旅程",
            "none": "无",
