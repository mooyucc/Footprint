...
class LanguageManager: ObservableObject {
    ...
    private func loadLocalizedStrings() {
        ...
        localizedStrings["zh-Hans"] = [
            ...
            "no_trip_records": "还没有记录旅程",
            "create_first_trip": "记录第一段旅程",
            "start": "开始",
            "end": "结束",
            "duration": "时长",
            "trip_route": "足迹路线",
            ...
            "edit_trip": "编辑旅程",
            "delete_trip": "删除旅程",
            "confirm_delete_trip": "确定要删除这段旅程吗？点亮的地方不会被删除。",
            "trip_info": "旅程信息",
            "trip_name": "旅程名称",
            ...
            "map_button_style": "样式",
            "map_button_import_photo": "导入照片",
            "footprints_action_menu": "快捷操作",
            "photo_import_error_title": "照片导入",
            "photo_import_failed_message": "无法加载所选照片，请重试。",
            "photo_import_missing_location_message": "照片缺少地理信息，已添加照片，请手动选择地点。",
            "locations_count": "个地点",
        ...
        localizedStrings["en"] = [
            ...
            "footprint_app": "MooFootprint - Life Footprint",
            ...
            // 旅程相关
            "my_trips": "My Routes",
            "search_trips": "Search routes",
            "create_trip": "Add Route",
            "import_trip": "Import Route",
            "import_result": "Import Result",
            "ok": "OK",
            "import_success": "Successfully imported route",
            "trip_exists": "Route already exists",
            "import_failed": "Import failed",
            "days": "days",
            "locations": "locations",
            "trip_statistics": "Route Statistics",
            "no_trip_records": "No routes yet",
            "create_first_trip": "Record First Route",
            "start": "Start",
            "end": "End",
            "duration": "Duration",
            ...
            "share_trip": "Share Route",
            "share_to_team": "Export Trip",
            "edit_trip": "Edit Route",
            "delete_trip": "Delete Route",
            "confirm_delete_trip": "Are you sure you want to delete this route? Associated footprints will not be deleted.",
            "trip_info": "Route Information",
            "trip_name": "Route Name",
            ...
            // 目的地详情视图相关
            "no_photo": "No Photo",
            "belongs_to_trip": "Belongs to Route",
            ...
            "map_button_import_photo": "Import Photo",
            "footprints_action_menu": "Quick Actions",
            "photo_import_error_title": "Photo Import",
            "photo_import_failed_message": "Unable to load the selected photo. Please try again.",
            "photo_import_missing_location_message": "No location metadata was found. The photo was added, please choose a place manually.",
            ...
            "belongs_to_trip_optional": "Belongs to Route (Optional)",
            ...
            "stats_share_footer": "✨ MooFootprint • Light Up Every Footprint",
            // Map Style
